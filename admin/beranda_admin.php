...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        // Hitung total Pesan
        $jumlah_pesan = mysqli_num_rows(mysqli_query($db, "SELECT id_pesan FROM tbl_pesan"));
        ?>
        <!-- Main Content -->
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
                ...
                <div class="bg-white shadow rounded p-4 text-center border-t-4 border-red-600">
                    <h3 class="text-xl font-semibold text-red-700">Pesan Diterima</h3>
                    <p class="text-3xl font-bold text-gray-800"><?php echo $jumlah_pesan; ?></p>
                </div>
            </div>
        </main>
    </div>
